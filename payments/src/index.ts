...
import { PurchaseCancelledListener } from './events/listeners/purchase-cancelled-listener';
...
//passing nats listener settings
new PurchaseCreatedListener(natsWrapper.client).listen();
new PurchaseCancelledListener(natsWrapper.client).listen();
